...
public class Permanentemployee : Employee {
    ...
    public Permanentemployee(string FirstName,string LastName,string JD,string RD,
    double MonthlySalary,double housingRentAllowance,double dearnessAllowance,double proviFund)
    :base(FirstName,LastName,MonthlySalary){
